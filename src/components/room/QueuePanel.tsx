    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="fixed top-24 bottom-24 right-4 w-80 z-40 flex flex-col bg-card/80 backdrop-blur-xl rounded-[2.5rem] shadow-[0_10px_40px_-10px_rgba(0,0,0,0.05)] border border-white/40 overflow-hidden"
        >
          {/* Header */}
